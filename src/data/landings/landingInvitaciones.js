export const landingInvitacionesContent = {
  es: {
    ...
    ui: {
      ...
      heroTrustGuarantee: "Garantía total",
  ...
  en: {
    ...
    ui: {
      ...
      heroTrustGuarantee: "Full guarantee",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "We give you a unique link (and a QR). Share it via WhatsApp, social, email, or whatever you prefer. On Premium VIP each guest gets their own link with their name.",
      },
      {
      ...
      },
      {
        ...
        a: "We offer a full guarantee: if you don't like the result, we refund your money. But first we'll try to get to a design you love — changes are unlimited.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes, on Pro and Premium VIP plans. Background music, entrance animations, cover video, and a collaborative playlist where guests suggest songs.",
      },
    ],
    testimonials: [
      {
        quote:
          "My guests loved the invitation, everyone confirmed, and no one got lost. The background music was the detail they commented on most.",
        name: "Ana García",
      ...
      {
        quote:
          "I saved time and money, and the invitation looked incredible. WhatsApp RSVP control changed my life — I knew exactly who was coming.",
        name: "Carlos Méndez",
        event: "Quinceañera · July 2025",
        avatar: "C",
        stars: 5,
      },
      {
        quote:
          "The baptism invitation was so sweet my friends borrowed the idea for their events. The process was super fast — ready in 4 days.",
        name: "Mariana López",
        event: "Baptism · September 2025",
        avatar: "M",
        stars: 5,
      },
    ],
