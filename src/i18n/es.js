export default {
  ...
  afterSales: {
    eyebrow: 'Post-lanzamiento',
    title: 'Tu sitio sigue evolucionando',
    subtitle: 'Hosting mantiene tu proyecto vivo. Mantenimiento lo mantiene util, actualizado y acompanado. Haz clic en un plan para ver el detalle.',
    popular: 'Popular',
    expand: 'Ver detalle',
    collapse: 'Cerrar detalle',
    close: 'Cerrar',
    detailCovers: 'Que cubre',
    detailNotCovers: 'Que no cubre',
    detailWhen: 'Cuando recomendarlo',
    footnote: 'Excedentes: $700 MXN/hora + IVA, minimo 30 min, con autorizacion previa. Las horas no se acumulan de un mes a otro.',
    plans: {
      hosting: {
        name: 'Hosting + Dominio',
        desc: 'Tu sitio publicado, seguro y disponible 24/7. Costo operativo que aplica a cualquier plan.',
        features: [
        ...
        covers: [
          'Servidor optimizado con disponibilidad y desempeno base',
          'Dominio personalizado que refuerza profesionalismo',
          'Certificado SSL para navegacion protegida',
          'Continuidad operativa sin riesgo de caida por vencimiento',
        ],
        notCovers: [
          'Cambios de contenido o diseno',
          'Nuevas secciones o funcionalidades',
          'Gestion de campanas, SEO o marketing',
          'Correcciones fuera de infraestructura',
        ],
        whenToUse: [
          'Siempre: es el minimo para que el proyecto siga activo',
          'Clientes que solo necesitan que el sitio siga en linea',
          'Base obligatoria para cualquier plan contratado',
        ],
      },
      'mantenimiento-basico': {
        name: 'Mantenimiento Basico',
        desc: 'Para sitios con cambios ocasionales y soporte cuando lo necesites.',
        features: [
        ...
        covers: [
          'Ajustes puntuales en textos, imagenes o bloques simples',
          'Canal directo con tiempo de respuesta estandar',
          'Revision de que el sitio siga activo',
          'Publicacion cubierta en el paquete',
        ],
        notCovers: [
          'Redisenos completos',
          'Trabajo por encima de 2 horas (se cotiza aparte)',
          'Funcionalidades complejas o integraciones nuevas',
          'Soporte inmediato o prioritario',
        ],
        whenToUse: [
          'Sitios que cambian poco',
          'Clientes que solo quieren respaldo ocasional',
          'Negocios que aun no necesitan respuesta rapida',
        ],
      },
      'mantenimiento-pro': {
        name: 'Mantenimiento Pro',
        desc: 'Para negocios activos que necesitan cambios frecuentes y respuesta rapida.',
        features: [
          'Hasta 5 horas de cambios/mes',
        ...
        covers: [
          'Ajustes frecuentes con mayor profundidad visual',
          'Respuesta mas rapida que en Basico',
          'Resumen de estado y desempeno tecnico',
          'Respaldo periodico ante errores o incidentes',
          'Infraestructura cubierta en el paquete',
        ],
        notCovers: [
          'Trabajo por encima de 5 horas (se cotiza aparte)',
          'Modulos nuevos grandes',
          'Replanteamiento completo de UX o branding',
          'Integraciones complejas o desarrollo custom',
        ],
        whenToUse: [
          'Clientes que actualizan seguido',
          'Sitios que participan activamente en ventas',
          'Negocios que valoran atencion mas rapida',
        ],
      },
      'mantenimiento-vip': {
        name: 'Mantenimiento VIP',
        desc: 'Acompanamiento continuo, rapidez y evolucion activa del proyecto.',
        features: [
          'Hasta 20 horas/mes de cambios',
          'Hasta 3 solicitudes en paralelo',
          'Soporte mismo dia (horario laboral)',
          'Nuevas secciones dentro del plan',
          'Reportes + recomendaciones mensuales',
          'Hosting premium incluido',
        ],
        covers: [
          'Bolsa amplia de contenido y diseno dentro del mismo proyecto',
          'Tres solicitudes simultaneas; el resto entra en fila',
          'Atencion rapida en horario laboral definido',
          'Evolucion continua sin mini-cotizaciones',
          'Seguimiento con sugerencias de mejora',
          'Infraestructura premium para clientes activos',
        ],
        notCovers: [
          'Horas por encima de 20 ($700 MXN/hora excedente)',
          'Mas de 3 solicitudes simultaneas (las demas hacen fila)',
          'Desarrollo enterprise o sistemas nuevos',
          'Replantear por completo el producto cada mes',
          'Soporte 24/7 si no se pacta expresamente',
        ],
        whenToUse: [
          'Sitios que cambian mucho',
          'Clientes que quieren rapidez y acompanamiento cercano',
          'Proyectos que siguen creciendo tras el lanzamiento',
        ],
      },
    },
  },
