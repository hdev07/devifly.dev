      ...
      >
        ...
        <div class="lg:col-span-5" data-animate>
          <div class="relative">
            ...
            <div
              aria-hidden="true"
              class="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-brand-500/30 via-cyan-glow/20 to-violet-soft/30 blur-2xl"
            ></div>

            <div
              class="relative rounded-3xl overflow-hidden border dark:border-white/10 border-light-border dark:bg-base-900/70 bg-light-surface/85 backdrop-blur-xl"
            >
              <!-- Photo -->
              <div class="aspect-[4/5] relative overflow-hidden">
                ...
                <div
                  v-else
                  class="absolute inset-0 bg-gradient-to-br from-brand-500/20 via-cyan-glow/10 to-violet-soft/20 flex items-center justify-center"
                >
                  <div class="relative">
                    <div
                      aria-hidden="true"
                      class="absolute inset-0 rounded-full bg-brand-500/40 blur-3xl"
                    ></div>
                    <div
                      class="relative w-32 h-32 rounded-full bg-gradient-to-br from-brand-500 to-cyan-glow flex items-center justify-center"
                    >
                      <span class="font-display text-6xl font-bold text-white"
                        >D.</span
                      >
                    </div>
                  </div>
                ...
                <!-- Bottom info bar -->
                <div
                  class="absolute inset-x-0 bottom-0 px-5 py-4 bg-gradient-to-t from-base-950/95 via-base-950/70 to-transparent backdrop-blur-sm"
                >
            ...
            <div
              class="absolute -bottom-6 -right-4 sm:-right-8 w-[200px] rounded-2xl border dark:border-white/10 border-light-border dark:bg-base-900/85 bg-light-surface backdrop-blur-xl p-4 shadow-glass-hover hidden sm:block"
            >
              <div class="flex items-center gap-2 mb-2">
                <LucideIcon name="award" class-name="w-4 h-4 text-amber-400" />
                <span
            ...
            <div
              class="absolute -top-4 -left-4 sm:-left-8 w-[180px] rounded-2xl border dark:border-white/10 border-light-border dark:bg-base-900/85 bg-light-surface backdrop-blur-xl p-4 shadow-glass-hover hidden sm:block animate-float"
              style="animation-delay: 1s"
            >
              <div class="flex items-center gap-2 mb-2">
                <span
                  class="block w-2 h-2 rounded-full bg-emerald-400 animate-pulse"
                ></span>
                <span
                  class="text-[10px] font-bold uppercase tracking-[0.15em] dark:text-text-secondary text-light-muted"
                >
        ...
        <div class="lg:col-span-7">
          ...
          <div
            data-animate
            class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8 delay-300"
          >
            <div
              v-for="promise in promises"
              :key="promise.icon"
              class="flex items-start gap-3 p-4 rounded-xl dark:bg-white/3 bg-light-card/60 border dark:border-white/8 border-light-border"
            >
              <div
                class="w-9 h-9 rounded-lg bg-brand-500/15 flex items-center justify-center shrink-0"
              >
                <LucideIcon
                  :name="promise.icon"
                  class-name="w-4 h-4 text-brand-400"
                />
              </div>
              <div>
                <div
          ...
          <!-- CTAs -->
          <div data-animate class="flex flex-wrap gap-3 delay-400">
            <a
              :href="callLink"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              :href="'https://www.linkedin.com/in/hdev07'"
              target="_blank"
              rel="noopener noreferrer"
              class="inline-flex items-center gap-2 px-6 py-3 rounded-full dark:bg-white/5 bg-light-card border dark:border-white/10 border-light-border dark:text-white text-light-text font-semibold text-sm hover:dark:border-brand-500/40 hover:border-brand-500/50 transition-all"
            >
              <LucideIcon name="linkedin" class-name="w-4 h-4" />
              LinkedIn
            </a>
          </div>
        </div>
...
// Auto-load founder photo from src/assets/img/founder
const photos = import.meta.glob("../assets/img/founder/*.{jpg,jpeg,png,webp}", {
  eager: true,
  import: "default",
});
