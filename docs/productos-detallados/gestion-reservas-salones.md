# Gestión de Reservas y Calendarios: Guía por Plan

Este documento responde a la pregunta del cliente: **"¿En dónde quedan registradas las reservas y cómo se gestionan?"** para el producto de Salones de Eventos.

---

## 1. Resumen de Flujo según el Plan

La gestión de la información escala desde una simple notificación hasta un sistema de administración completo (CRM).

### 1.1 Plan Esencial ($5,999 MXN)
*   **¿Dónde se registran?** No hay una base de datos interna. Las solicitudes llegan como **notificaciones directas a tu Correo Electrónico y a tu WhatsApp**.
*   **¿Quién las aprueba?** El dueño del salón de forma manual. Recibes el mensaje, contactas al cliente y cierras el trato fuera de la página.
*   **¿Se aprueban automáticamente?** No. En este plan, la web funciona como una herramienta de captura de prospectos (leads), no como un sistema de reserva autónomo.
*   **¿El calendario se actualiza solo?** No incluye calendario de disponibilidad. La gestión de fechas sigue siendo manual (en tu agenda física o digital personal).

### 1.2 Plan Pro ($9,999 MXN)
*   **¿Dónde se registran?** Las solicitudes llegan vía Email/WhatsApp con los datos del **Cotizador en Línea**.
*   **¿Quién las aprueba?** El dueño del salón. El sistema permite al cliente ver qué fechas están libres, pero la "reserva" oficial se confirma tras el contacto humano.
...
*   **¿El calendario se actualiza solo?** **Totalmente automático.** Al confirmarse una reserva en el sistema (vía pago o cambio de estatus manual en el CRM), el calendario de la web se actualiza en tiempo real para evitar sobreventas (double-booking).

---

## 2. Preguntas Frecuentes de Operación
...
| **Calendario** | No incluido | **Sincronizado (Google)** | **Automático (Sistema)** |
| **Pagos de Apartado** | No | No | **Sí, integrados** |
| **Contratos** | No | No | **Digitales incluidos** |
...
**Si el cliente apenas está digitalizándose:**
> "En el **Plan Esencial**, la página te avisa por WhatsApp cada vez que alguien quiere información. Tú sigues teniendo el control total de tu agenda como lo haces hoy, pero con prospectos mucho más calificados."
