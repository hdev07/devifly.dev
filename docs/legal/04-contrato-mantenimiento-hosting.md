# CONTRATO DE MANTENIMIENTO, HOSTING Y SOPORTE

> **Cuándo usarlo:** al cerrar el proyecto, cuando el cliente contrata un plan recurrente. Es el contrato que convierte un proyecto de una sola venta en ingreso mensual predecible. Fírmalo el mismo día del acta de entrega, mientras el cliente está contento.
...
EL PRESTADOR prestará a EL CLIENTE los servicios de alojamiento, mantenimiento, soporte técnico y evolución del producto digital identificado como:

| | |
|---|---|
| **Producto** | [NOMBRE DEL SITIO / SISTEMA] |
| **Dominio** | [DOMINIO] |
| **Repositorio** | [URL DEL REPOSITORIO] |
| **Plan contratado** | [ Hosting / Básico / Pro / VIP ] |

## SEGUNDA — PLANES Y ALCANCE

EL CLIENTE contrata el plan marcado a continuación:

### ☐ Plan Hosting — $199 MXN/mes o $1,999 MXN/año

- Alojamiento en infraestructura cloud con CDN global.
- Certificado SSL y renovación automática.
- Renovación del dominio.
- Respaldos automáticos semanales, con retención de 30 días.
- Monitoreo de disponibilidad.
- **No incluye** cambios de contenido ni desarrollo.

### ☐ Plan Básico — $999 MXN/mes

Todo lo del plan Hosting, más:

- Hasta **2 horas** mensuales de cambios de contenido (textos, imágenes, precios, productos).
...
### ☐ Plan Pro — $1,999 MXN/mes

Todo lo del plan Básico, más:

- Hasta **5 horas** mensuales de cambios y mejoras.
- Reporte mensual de tráfico, conversiones y desempeño.
- Optimización continua de SEO técnico y velocidad.
- Tiempo de primera respuesta: 8 horas hábiles.

### ☐ Plan VIP — $3,499 MXN/mes
...
**a)** Rediseños completos o cambios de identidad visual.

**b)** Desarrollo de módulos o sistemas nuevos que constituyan un proyecto en sí mismos.

**c)** Producción fotográfica, de video o redacción de contenido desde cero.

**d)** Gestión de redes sociales o campañas de publicidad pagada.
...
**a)** Ventanas de mantenimiento programado, notificadas con al menos 48 horas de anticipación.

**b)** Fallas atribuibles a proveedores de infraestructura, red o servicios de terceros.

**c)** Casos fortuitos o de fuerza mayor.

**d)** Interrupciones causadas por acciones de EL CLIENTE.
...
| Concepto | Monto |
|---|---|
| Plan contratado | $[MONTO] MXN |
| Periodicidad | [ Mensual / Anual ] |
| IVA (16%) *(si requiere factura)* | $[MONTO] |
| **Total por periodo** | **$[MONTO]** |

El pago se realiza por **anticipado**, dentro de los primeros **5 (cinco) días naturales** de cada periodo, mediante transferencia SPEI o el medio que LAS PARTES acuerden.
...
- Una guía de migración a la infraestructura que EL CLIENTE elija.
- El control del dominio y de los registros DNS.
